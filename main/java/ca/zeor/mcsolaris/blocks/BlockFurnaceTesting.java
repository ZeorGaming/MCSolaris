...
import ca.zeor.mcsolaris.help.*;
import ca.zeor.mcsolaris.init.ModBlocks;
import ca.zeor.mcsolaris.blocks.*;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class BlockFurnaceTesting extends BlockContainer {
	...
	protected BlockFurnaceTesting(boolean isActive) {
		super(Material.rock);
		isBurning2 = isActive;
	}
	...
	public void registerBlockIcons(IIconRegister iconregister) {
		this.blockIcon = iconregister.registerIcon(Reference.MODID + ":TutFurnaceSide");
		this.front = iconregister.registerIcon(this.isBurning2 ? Reference.MODID + ":TutFurnaceActive" : Reference.MODID + ":TutFurnaceInactive");
		this.top = iconregister.registerIcon(Reference.MODID + ":TutFurnaceTop");
	}
	...
	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(ModBlocks.BlockFurnaceTesting);
	}
