...
public class BlockSiftExtractor extends Block{
	...
	public void registerBlockIcons(IIconRegister iconregister) {
		this.blockIcon = iconregister.registerIcon(Reference.MODID + ":SiftExtractor_2");
		this.top = iconregister.registerIcon(Reference.MODID + ":SiftExtractor_1");
	}
	...
	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(ModBlocks.SiftExtractor);
	}
